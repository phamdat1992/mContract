            ...
            {showResults ? <>
                            ...
                            <div className="col-12 col-lg-7">
                                <div className="text_info">
                                    <div className="title mb-2">
                                        <p className="content_vi">Chính sách bảo mật</p>
                ...
                <div className="container content intro-extra">
                    <div className="content_vi">
                        ...
                        <p> <b><i>“MContract”</i></b> nghĩa là Công Ty TNHH Dịch Vụ Công Nghệ Trực Tuyến. Trong Chính Sách Bảo Mật này,  MContract có thể  được đề cập là “Chúng Tôi” tùy theo ngữ cảnh.
                        </p>
                        <p>
                        ...
                        <p><b><i>“Người Dùng”</i></b> nghĩa là cá nhân/tổ chức sử dụng Dịch Vụ.
                    ...
                    <div className="container">
                        <div className="row info" data-aos="fade-up">
                            <div className="col-12 col-lg-7">
                                <div className="text_info">
                                    <div className="title mb-2">
                                        <p className="content_en">PRIVACY POLICY</p>
                ...
                <div className="language">
                    <button type="button" id="vi" className="btn btn-primary" onClick={() => { setShowResults(true) }}>
                        <img src="/images/vietnam.webp" className="rounded-circle" alt="" loading="lazy" /> <span className="name_language">Tiếng Việt</span>
                    </button>
                </div>
                <div className="container content intro-extra">
                    <div className="content_en">
                        ...
                        <p> 
                            <b><i>“MContract”</i></b>, also know as "ONLINE TECHNOLOGY SERVICES COMPANY LIMITED". In this Privacy Policy, MContract may be referred to as "We" depending on the context.
