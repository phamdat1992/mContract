...
class CI_DB_pdo_driver extends CI_DB
{
    ...
    function db_connect()
    {
        ...
        if ($this->sslkey != "" && $this->sslcert != "" && $this->sslCA != "") {
            $this->options['PDO::MYSQL_ATTR_SSL_KEY'] = $this->sslkey;
            $this->options['PDO::MYSQL_ATTR_SSL_CERT'] = $this->sslcert;
            $this->options['PDO::MYSQL_ATTR_SSL_CA'] = $this->sslCA;
        }
